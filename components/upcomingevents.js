    ...
    <>
      <FadeInSection><div className="section">
        ...
        <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}><div style={{display: 'flex', alignItems: 'left', justifyContent: 'center', flexDirection: 'column'}} className="upcomingEvents">
          ...
          <span style={{display: 'flex', alignItems: 'center', marginBottom: 10}}><FontAwesomeIcon icon={faCalendarAlt} width="20" height="20" className="icon"/> &nbsp; &nbsp; <a href="https://docs.google.com/forms/d/e/1FAIpQLSctj81LdQ9ZQ4CTDV6YVbkwtS5gI2X_wvGNc1SeRSs2nQiprQ/viewform"><b>CADTable Workshop - Building Parts</b>: March 22nd at 7 PM PT</a></span>
          <span style={{display: 'flex', alignItems: 'center', marginBottom: 10}}><FontAwesomeIcon icon={faCalendarAlt} width="20" height="20" className="icon"/> &nbsp; &nbsp; <a href="https://docs.google.com/forms/d/e/1FAIpQLSctj81LdQ9ZQ4CTDV6YVbkwtS5gI2X_wvGNc1SeRSs2nQiprQ/viewform" style={{fontWeight: 300, color: 'white', textDecoration: 'none'}}><b>CADTable Workshop - Integrating Parts into Assemblies</b>: March 23rd at 4:30 PM PT</a></span>
          ...
          <span style={{display: 'flex', alignItems: 'center', marginBottom: 10}}><FontAwesomeIcon icon={faCalendarAlt} width="20" height="20" className="icon"/> &nbsp; &nbsp; <a href="https://docs.google.com/forms/d/e/1FAIpQLSctj81LdQ9ZQ4CTDV6YVbkwtS5gI2X_wvGNc1SeRSs2nQiprQ/viewform"><b>CADTable Workshop - Rendering CAD</b>: March 28th at 5 PM PT</a></span>
