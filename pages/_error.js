        ...
        <div className="section">
            ...
            <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                <ul style={{textAlign: 'left'}}>
                    ...
                    <li className="tab"><Link href='/accomplishments' as={ process.env.PUBLIC_URL + '/accomplishments'}><a id="Accomplishments" className="tab-label">Accomplishments</a></Link></li>
